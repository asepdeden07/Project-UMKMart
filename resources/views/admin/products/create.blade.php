...
@section('content')
    <div class="max-w-2xl">
        <div class="mb-6">
            ...
            <p class="text-gray-500 mt-1">Isi informasi produk dengan lengkap</p>
        </div>

        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-emerald-500 transition-colors duration-200 @error('image') border-red-500 @enderror"
                    ...
                    <div id="uploadPrompt">
                        ...
                        <p class="text-gray-600 font-medium">Klik atau drag foto di sini</p>
